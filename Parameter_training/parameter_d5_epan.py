...
from Function_diff_block import generate_data, local_parameter_h_test
import numpy as np
...
3. save parameters
'''
# trails_d5_epan['global_h'] = global_h
# trails_d5_epan['local_h'] = local_h
trails_d5_epan['local_h_diff'] = local_h
