...
global_hs = trails_d1_naive['global_h']
local_hs = trails_d1_naive['local_h']
# local_hs = trails_d1_naive['local_diff_h']
...
3. save MSE
'''
trails_d1_naive['GEs'] = GEs
trails_d1_naive['LEs'] = LEs
trails_d1_naive['AEs'] = AEs
trails_d1_naive['AE_adapts'] = AE_adapts
trails_d1_naive['AE_log_actives'] = AE_log_actives
# trails_d1_naive['AE_logs'] = AE_logs
