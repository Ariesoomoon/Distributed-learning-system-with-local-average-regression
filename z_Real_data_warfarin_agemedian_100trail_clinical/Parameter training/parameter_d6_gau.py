import os, time
from Function_same_block_warfarin import generate_data, global_parameter_h, local_parameter_h_test
...
3. save parameters
'''
# warfarin_gau['global_h'] = global_h
warfarin_gau['local_h'] = local_h
# # warfarin_gau['local_h_diff'] = local_h
